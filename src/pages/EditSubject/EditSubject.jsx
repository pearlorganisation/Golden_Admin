...
import {
  ...
  getSingleSubject,
  updateSubject,
} from "../../features/actions/subjectActions";
...
const EditSubject = () => {
  ...
  console.log(singleSubject, "Single Subject on Edit page");
  ...
  const {
    ...
    defaultValues: {
      ...
      pages: singleSubject?.pages || "",
      price: singleSubject?.price || "",
      discountedPrice: singleSubject?.discountedPrice || "",
      banner: singleSubject?.banner || null,
      pdf: singleSubject?.pdf || null,
    },
  });
  ...
  const onSubmit = (data) => {
    ...
    setLoading(true);
    dispatch(updateSubject({ id: singleSubject._id, userData: formData }));
    setLoading(false);
  };
  ...
  return (
    <div className="ml-72">
      <div className="container mx-auto p-10">
        ...
        >
          {!imagePreview && singleSubject?.banner?.length > 0 && (
            <div className="flex space-x-4">
              {singleSubject?.banner?.map((src, index) => (
                <img
                  key={index}
                  src={src?.secure_url}
                  alt={`preview-${index}`}
          ...
          <>
            ...
            >
              {isLoading ? "Editing..." : "Edit Subject"}
            </button>
          </>
