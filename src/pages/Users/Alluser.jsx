...
function Alluser() {
  ...
  if (isError) return <div className="text-center text-red-500 p-4">Error: {message}</div>;
          ...
          <table className="min-w-full table-auto">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2 text-left text-sm font-medium text-gray-600">Verified</th>
              </tr>
            </thead>
            <tbody>
              {user.data.map((item) => (
