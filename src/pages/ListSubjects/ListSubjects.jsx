...
const ListSubjects = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteSubject(selectedSubjectId));

    if (Array.isArray(subjects) && subjects.length === 1 && currentPage > 1) {
      dispatch(getAllSubjects({ page: currentPage - 1 }));
    } else if (
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  {subjects?.length > 0 && Array.isArray(subjects) ? (
                    <>
                      {subjects?.map((subject, index) => (
                        ...
                        >
                          ...
                          <td className="px-2 py-3">
                            {moment(subject?.createdAt).format("D MMM YYYY")}
                          </td>
                              ...
                              <ul className="py-1 text-sm text-gray-700 dark:text-gray-200 flex flex-row gap-3 mt-5">
                                <button
                                  ...
                                  onClick={(e) => {
                                    e.preventDefault();
                                    navigate(
                                      `/dashboard/viewSubject/${subject?._id}`
                                    );
                                  }}
                                >
                                  View
                    ...
                    <h1 className="pt-4 text-4xl"> No Subjects Found</h1>
                  )}
                </tbody>
              </table>
